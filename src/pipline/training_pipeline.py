...
class Traininpipeline:
    ...
    def start_data_transformation(self,data_ingestion_artifact: DataIngestionArtifact, data_validation_artifact: DataValidationArtifact)-> DataIngestionArtifact:
        try:
    ...
    def start_model_evaluation(self,data_ingestion_artifact:DataIngestion,model_trainer_artifact:ModelTrainerArtifact)->ModelEvaluationArtifact:
        try:
    ...
    def start_model_pusher(self,model_evaluation_artifact:ModelEvaluationArtifact)-> ModelPusherArtifact:
        try:
            pusher= ModelPusher(model_evaluation_artifact=model_evaluation_artifact, model_pusher_config=self.model_pusher_config)
